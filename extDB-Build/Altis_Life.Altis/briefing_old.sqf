...
player createDiarySubject ["safezones","Zonas Seguras (Sem matança)"];
//player createDiarySubject ["civrules","Regras dos Civís"];
...
player createDiarySubject ["controls","Controles e Comandos"];
...
*/
		...
		[
			"Change Log Oficial",
				"
					v0.8
					/*
					//Pode ser ouvido por todos do seu lado (civíl, médico e polícia) independente do local onde o jogador está. Isso incomoda e atrapalha, portanto para falar use o chat direto para falar com alguem proximo. (Veja seção 'Controles e Comandos')
					- Correções de bugs menores no servidor.
					- Inserido códigos para melhorar o suporte a funcionalidades futuras.
					- Inserido novas funcionalidades no núcleo do servidor.
					- Mais textos localizados. Isso significa menos coisas em inglês.
					
					Ainda existem muitos textos sem traduzir, sabemos disso mas tenha paciência. A cada atualização novas traduções serão inseridas.
					Se tiver inglês e português FLUENTES e queira ajudar, sinta-se encorajado a entrar em contato com a administração (Ver seção 'Contato" em 'Notas').
					Participe do programa de recompensas para cada bloco de texto traduzido e aceito pela administração com valores de até 150 mil dinheiros in-game!
					
					
					Novas funcionalidades estão desativadas durante o período de testes no servidor principal. Assim que estiverem estáveis serão ativadas numa atualização futura.
					
					v0.1 - v0.7.x
					
					- Localização do mapa para Português do Brasil.
					- Correções de posicionamento nos NPCs.
					- Loja de Equipamentos:
					   1. Adicionado: Focalizador (rangefinder) = R$3500.
					   2. Adicionado: Mapa = R$30.
					   3. Adicionado: GPS = R$100.
					   4. Adicionado: Bussola = R$50.
					   5. Adicionado: Relógio = R$50.
					   6. Adicionado: Revolver Sinalizador (não letal) = R$300.
					   7. Adicionado: Cartucho Sinalizador Vermelho = R$30.
					   8. Adicionado: Cartucho Sinalizador Verde = R$30.
					   9. Balanceamento de preço: Óculos de Visão Noturna = R$3200 -> R$15350.
					   
					- Loja de Armas:
					   1. Adicionado: Mira Yorris J2 para pistola = R$500.
					   2. Adicionado: Mira M.R.D. para pistol = R$500.
					   3. Adicionado: Mira A.C.O. na cor Verde para submetralhadora = R$950.
					   4. Adicionado: Mira Holográfica MK17 para submetralhadora = R$1500.
					   5. Adicionado: Silenciadores 9mm (R$800) e .45 ACP (R$1500).
					   
					- Loja de Armas Rebelde:
					   1. Adicionado novas armas rebeldes: rifles de assalto, carabinas, fuzis, metralhadoras leves e pesadas e rifles de precisão.
					   2. Adicionado novas muniçoes normais, traçantes, perfurantes e sub-aquática.
					   3. Adicionado novas munições das variantes de lança-granadas EGLM e 3GL, incluindo explosivas, fumaça e sinalizadores.
					   4. Adicionado novas miras telescópicas de curto, médio e longo alcance e de precisão.
					   5. Adicionado novos acessórios, incluindo lanterna e mira laser infravermelho.
					
					- Loja de Roupas Rebelde:
					   1. Adicionado novas roupas, coletes e capacetes.
					
					- Corrigido a sobreposição dos icones de fome, sede e saúde com outros elementos do HUD.
					- Adicionado novos veiculos terrestres e aéreos.
					*/
				"
		]
	];
	...
	/*player createDiaryRecord["changelog",
		...
		[
			"Exploits", 
				"
				Estes são considerados explorações de falhas ou bugs e você não vai ser apenas expulso do jogo, mas banido!<br/><br/>

				1. Sair da prisão através de qualquer método que não seja o pagamento de fiança ou escapar através do helicóptero.<br/>
				2. Matar-se para sair do roleplay. Fugir para nao ser imobilizado por taser, contido, preso, etc. Se o log no servidor mostrar que foi preso e cometeu suicídio, você poderá ser banido. Além disso, você não será perdoado de seus crimes e continuará na lista de procurado! AO estar preso, não pagar fiança e matar-se para fugir não apenas falhará como também aumentará o tempo de prisão. Cumpra sua pena! Ao ser liberado depois de cumprir sua pena, não se mate ou aborte a missão para voltar rapidamente, siga o roleplay de siimulação e caminhe sem preguiça.<br/>
	...
	player createDiaryRecord["safezones",
		[
			"Zonas Seguras",
				"
					Se sair explodindo (e explodindo pode ser, por exemplo, explodir intencionalmente um veículo), nocauteando, roubando ou matando ao redor ou dentro dessas áreas, você poderá e será punido com bloqueio temporário ou permanente de acordo com a gravidade da ação e a avaliação dos administradores.<br/><br/>
					...
					Lojas especiais e de doadores<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Ofensas baníveis", 
				"
				Considere esse seu primeiro e único aviso.<br/><br/>
				
				1. Hacking<br/>
				2. Cheating<br/>
				3. Exploiting (Veja a seção 'Exploits')<br/>
				...
				12. Não passar as instruções CLARAMENTE ao realizar roubos e assaltos à(s) vítima(s).<br/><br/>
				
				Fique atento ao chat, nem todos possuem microfone ou podem estar passando por algum problema! Seja razoável e tenha bom senso acima e antes de tudo.<br/><br/>
				"
		]
	];
