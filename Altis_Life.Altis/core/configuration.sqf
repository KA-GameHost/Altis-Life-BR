...
life_respawn_timer = 0.50; //Scaled in minutes
life_knockout = false;
...
__CONST__(life_revive_fee,20000); //Fee for players to pay when revived.
...
__CONST__(life_gangUpgradeBase,80000); //MASDASDASD
...
//[shortVar,reward]
life_illegal_items = [["heroinu",18500],["heroinp",35000],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",25000],["blastingcharge",35000],["boltcutter",7500]];
