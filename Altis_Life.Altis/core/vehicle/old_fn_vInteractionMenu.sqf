...
//#include <macro.h> //para admin impound
...
/*
	...
	//impound pra admin fim
*/
	
	//removida linha abaixo para admin impound
	_Btn4 ctrlShow false; //padrao: false
